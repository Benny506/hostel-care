...
const navItems = [
    { name: 'Overview', icon: <HiOutlineHome size={22} />, path: '/student-dashboard' },
    ...
    const NavContent = () => (
        <div className="d-flex flex-column h-100 p-4 pt-5">
            <div className="mb-5 d-flex align-items-center gap-3 px-2">
                <img src="/logo.svg" alt="Hostel Care" width="40" height="40" className="shadow-gold-heavy rounded-3" />
                <div>
                    <h5 className="mb-0 fw-black text-white tracking-tight">Hostel Care</h5>
                    <Badge className="bg-gold-glow text-gold p-1 px-2 smaller fw-bold uppercase tracking-widest border border-gold border-opacity-10">Resident</Badge>
                </div>
            </div>
                ...
                >
                    ...
                    <div className="d-flex align-items-center gap-3">
                        <div className="d-none d-md-flex flex-column align-items-end me-2">
                            ...
                            {userProfile?.institutional_id && (
                                <span className="text-muted smaller fw-medium uppercase tracking-tighter" style={{ fontSize: '10px' }}>
                                    {userProfile.institutional_id}
                                </span>
                            )}
                        </div>
